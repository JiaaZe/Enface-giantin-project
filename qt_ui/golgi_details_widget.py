...
class Ui_Golgi_details(object):
    def setupUi(self, Golgi_details):
        ...
        self.sub_value = QtWidgets.QLineEdit(self.frame)
        self.sub_value.setMinimumSize(QtCore.QSize(70, 28))
        self.sub_value.setMaximumSize(QtCore.QSize(70, 28))
        self.sub_value.setObjectName("sub_value")
        self.horizontalLayout.addWidget(self.sub_value)
        self.btn_sub = QtWidgets.QPushButton(self.frame)
        self.btn_sub.setMinimumSize(QtCore.QSize(70, 30))
        self.btn_sub.setMaximumSize(QtCore.QSize(70, 30))
    ...
    def retranslateUi(self, Golgi_details):
        ...
        self.btn_sub.setText(_translate("Golgi_details", "Subtract"))
