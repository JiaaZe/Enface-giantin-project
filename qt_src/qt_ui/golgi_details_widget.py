...
class Ui_Golgi_details(object):
    def setupUi(self, Golgi_details):
        ...
        self.gridLayout.addWidget(self.golgi_content_widget, 0, 0, 3, 1)
        ...
        self.browser_error = QtWidgets.QTextBrowser(self.frame)
        self.browser_error.setMinimumSize(QtCore.QSize(225, 60))
        self.browser_error.setMaximumSize(QtCore.QSize(225, 60))
        self.browser_error.setObjectName("browser_error")
        self.verticalLayout.addWidget(self.browser_error)
        ...
        self.label_c1.setMinimumSize(QtCore.QSize(30, 0))
        self.label_c1.setMaximumSize(QtCore.QSize(30, 16777215))
        ...
        self.btn_sub_c1.setMinimumSize(QtCore.QSize(75, 30))
        self.btn_sub_c1.setMaximumSize(QtCore.QSize(75, 30))
        ...
        self.label_c2.setMinimumSize(QtCore.QSize(30, 0))
        self.label_c2.setMaximumSize(QtCore.QSize(30, 16777215))
        ...
        self.btn_sub_c2.setMinimumSize(QtCore.QSize(75, 30))
        self.btn_sub_c2.setMaximumSize(QtCore.QSize(75, 30))
        ...
        self.label_c3.setMinimumSize(QtCore.QSize(30, 0))
        self.label_c3.setMaximumSize(QtCore.QSize(30, 16777215))
        ...
        self.btn_sub_c3.setMinimumSize(QtCore.QSize(75, 30))
        self.btn_sub_c3.setMaximumSize(QtCore.QSize(75, 30))
        ...
        self.btn_export.setMinimumSize(QtCore.QSize(100, 30))
        self.btn_export.setMaximumSize(QtCore.QSize(100, 30))
